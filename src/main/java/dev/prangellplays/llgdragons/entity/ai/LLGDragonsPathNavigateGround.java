package dev.prangellplays.llgdragons.entity.ai;
...
public class LLGDragonsPathNavigateGround extends MobNavigation {
    public LLGDragonsPathNavigateGround(PathAwareEntity entity, World world) {
        super(entity, world);
    }

    @Override
    protected PathNodeNavigator createPathNodeNavigator(int maxVisitedNodes) {
        this.nodeMaker = new LLGDragonsWalkNodeProcessor();
        this.nodeMaker.setCanEnterOpenDoors(true);
        return new LLGDragonsPathFinder(this.nodeMaker, maxVisitedNodes);
    }
