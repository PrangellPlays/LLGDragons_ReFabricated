...
public class NightfuryEggEntity extends MobEntity implements GeoEntity {
    ...
    private PlayState predicate(AnimationState<NightfuryEggEntity> nightfuryEntityAnimationState) {
    ...
    protected static final TrackedData<Optional<UUID>> OWNER_UNIQUE_ID = DataTracker.registerData(NightfuryEggEntity.class, TrackedDataHandlerRegistry.OPTIONAL_UUID);
    private static final TrackedData<Integer> DRAGON_AGE = DataTracker.registerData(NightfuryEggEntity.class, TrackedDataHandlerRegistry.INTEGER);

    public NightfuryEggEntity(EntityType<NightfuryEggEntity> type, World worldIn) {
        super(type, worldIn);
    }

    public static DefaultAttributeContainer.Builder createNightfuryEggAttributes() {
