...
public class AztecNightfuryEggEntity extends DragonEggEntity implements GeoEntity {
    ...
    private PlayState predicate(AnimationState<AztecNightfuryEggEntity> dragonEggEntityAnimationState) {
    ...
    public AztecNightfuryEggEntity(EntityType<? extends AztecNightfuryEggEntity> type, World worldIn) {
        super(type, worldIn);
    }
